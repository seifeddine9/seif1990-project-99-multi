...
var validator = (function($){
	...
	*/
	message = {
		...
		empty			: 'mettre quelque chose',
		min				: 'entrée est trop court',
		max				: 'entrée est trop longue',
		number_min		: 'trop bas',
		number_max		: 'trop haut',
		url				: 'URL invalide',
		number			: 'pas un nombre',
		email			: 'Adresse email invalide',
		email_repeat	: 'Les mails ne correspondent pas',
		password_repeat	: 'Les mots de passe ne correspondent pas',
		repeat			: 'aucune concordance',
		complete		: 'entrée est incomplète',
